...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if(isset($_POST['dataId'])){
        ...
        $result = mysqli_query($conn, "SELECT * FROM sickcall WHERE id = $dataId");
        ...
        if ($result) {
            ...
            $updateQuery = "UPDATE sickcall SET reason=?, remarks=?, status_id=? WHERE id=?";
            ...
            if ($updateResult) {
                ...
                VALUES (?, 'Sickcall', 'unread', ?, ?, 'Decline', ?, ?)";

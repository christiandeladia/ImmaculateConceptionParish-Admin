...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if(isset($_POST['dataId'])){
        ...
        $result = mysqli_query($conn, "SELECT * FROM blessing WHERE id = $dataId");
        ...
        if ($result) {
            ...
            $updateQuery = "UPDATE blessing SET reason=?, remarks=?, status_id=? WHERE id=?";
            ...
            if ($updateResult) {
                ...
                VALUES (?, 'blessing', 'unread', ?, ?, 'Decline', ?, ?)";

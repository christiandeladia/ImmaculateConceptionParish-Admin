...
$sql = "SELECT m.*, l.email AS user_email FROM `binyag_request_certificate` AS m
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if (!empty($email)) {
            try {
                ...
                $mail->Subject = 'Baptismal Request Certificate Declined';
                ...
                <p style="font-size: 16px;"><strong>We are Sorry to inform you that your application for Request Certificate on Baptismal with ' . $row["reference_id"] . ' has been Declined.</strong></p>

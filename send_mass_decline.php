...
$sql = "SELECT m.*, l.email AS user_email FROM `mass` AS m
        ...
        $email = $row["user_email"];
            ...
            if (!empty($email)) {
                try {
                    ...
                    $mail->Subject = 'Mass Application Declined';
                    ...
                    <p style="font-size: 16px;"><strong>We are Sorry to inform you that your application for Mass with ' . $row["reference_id"] . ' has been Declined.</strong></p>
                    ...
                    echo "<script>alert('Sent Successfully'); document.location.href = 'mass.php';</script>";
                    exit;
                } catch (Exception $e) {

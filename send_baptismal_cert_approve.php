...
if ($num_rows > 0) {
    ...
    if (!empty($email)) {
        ...
        $mail->Subject = 'Baptismal Request Certificate Approved';
...
<h2 style="color: #333333; font-size: 24px; font-weight: bold; text-align: center;"></h2>
            ...
            <p style="font-size: 16px;"><strong>We are pleased to inform you that your application for Baptismal Cetificate with ' . $row["reference_id"] . ' has been approved.</strong></p>
        ...
        if ($mail->send()) {
            ...
            echo "<script>alert('Sent Successfully'); document.location.href = 'certificate_baptismal.php';</script>";
            exit;
        } else {

    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if (!empty($email)) {
            try {
                ...
                $mail->Subject = 'Funeral Application Declined';
                $mail->Body = '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: linear-gradient(#93C572, #FFFFFF);">
                    ...
                    <p style="font-size: 16px;"><strong>We are Sorry to inform you that your application for Funeral with ' . $row["reference_id"] . ' has been Declined.</strong></p>

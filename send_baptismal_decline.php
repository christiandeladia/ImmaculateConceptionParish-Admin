    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if (!empty($email)) {
            try {
                ...
                $mail->Subject = 'BaPtismal Application Declined';
                ...
                <p style="font-size: 16px;"><strong>We are Sorry to inform you that your application for Baptismal with ' . $row["reference_id"] . ' has been Declined.</strong></p>

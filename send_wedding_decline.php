    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if (!empty($email)) {
            try {
                ...
                $mail->Subject = 'Wedding Application Declined';
                ...
                <h2 style="color: #333333; font-size: 24px; font-weight: bold; text-align: center;"></h2>
                                ...
                                <p style="font-size: 16px;"><strong>We are Sorry to inform you that your application for Wedding with ' . $row["reference_id"] . ' has been Declined.</strong></p>

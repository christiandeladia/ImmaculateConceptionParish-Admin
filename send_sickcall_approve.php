...
$sql = "SELECT m.*, l.email AS user_email FROM `sickcall` AS m
...
if ($num_rows > 0) {
    ...
    if (!empty($email)) {
        try {
            ...
            $mail->Subject = 'Sickcall Application Approved';
...
<h2 style="color: #333333; font-size: 24px; font-weight: bold; text-align: center;"></h2>
            ...
            <p style="font-size: 16px;"><strong>We are pleased to inform you that your application for Wedding with ' . $row["reference_id"] . ' has been approved.</strong></p>
            ...
            We are pleased to inform you that your application for Mass with ' . $row["reference_id"] . ' has been approved.
            <br>
            ...
            <br>
            <strong>Should you require any further assistance or have additional inquiries regarding the services provided, please feel free to contact our dedicated team. You can reach us by phone at [phone number] or via email at ' . $mail->Username . '.</strong> </p> </p>

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if(isset($_POST['dataId'])){
        ...
        $result = mysqli_query($conn, "SELECT * FROM binyag_request_certificate WHERE id = $dataId");
        ...
        if ($result) {
            ...
            $updateQuery = "UPDATE binyag_request_certificate SET reason=?, remarks=?, status_id=? WHERE id=?";
            ...
            if ($updateResult) {
                ...
                VALUES (?, 'Binyag Request Certificate', 'unread', ?, ?, 'Decline', ?, ?)";
        ...
        <script>
            ...
            header("Location: certificate_baptismal.php");
            exit();
        </script>
        <?php
    }
